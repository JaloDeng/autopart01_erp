...
-- 财务汇款现金结算明细
-- ----------------------------------------------------------------------------------------------------------------
DROP TABLE if EXISTS erf_supplier_cash_detail;
CREATE TABLE `erf_supplier_cash_detail` (
  ...
  `priceSumCome` decimal(20,4) DEFAULT 0 COMMENT '总额，进价+运费',
  ...
  `supplierReceiving` decimal(20,4) DEFAULT 0 COMMENT '供应商要求收取费用，供应商告知采购当次付款金额',
  ...
  `code` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '汇款单号，格式：采购单号-001',
